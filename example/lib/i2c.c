...
int i2c_master_init(I2C_t *i2c)
{
	...
	if (i2c == _I2C1) {
		...
		io_configure(I2C1_GPIO_PORT, I2C1_GPIO_PINS, I2C_PIN_CONFIG, NULL);
		irqn            = I2C1_EV_IRQn;
		...
		io_configure(I2C2_GPIO_PORT, I2C2_GPIO_PINS, I2C2_GPIO_CONFIG, NULL);
		irqn            = I2C2_EV_IRQn;
		...
		io_configure(I2C3_GPIO_PORT, I2C3_GPIO_PINS, I2C3_GPIO_CONFIG, NULL);
		irqn            = I2C3_EV_IRQn;
